...
// Config Imports
import themeConfig, { palette } from '@configs/themeConfig'
...
const Navbar = (props: Props) => {
  ...
  return (
    <StyledHeader
      theme={theme}
      overrideStyles={{ ...overrideStyles, '--background-color-rgb': palette.secondary['800'] }}
    ...
    >
      <div className={classnames(verticalLayoutClasses.navbar, 'flex bs-full !bg-port-gore-950')}>{children}</div>
    </StyledHeader>
  )
}
